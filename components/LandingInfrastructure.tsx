                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <FadeIn>
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            ...
                            <Link
                                href="#services"
                                className="inline-flex items-center justify-center bg-white dark:bg-slate-900 text-pink-600 font-medium px-8 py-4 rounded-lg border border-slate-200 dark:border-slate-800 hover:border-pink-600 transition-colors"
                            >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    <FadeIn delay={0.1}>
                        <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 text-center hover:border-pink-500/30 transition-colors">
                            ...
                            <div className="text-sm font-medium text-slate-500 dark:text-slate-400">Countries</div>
                        </div>
                    </FadeIn>
                    <FadeIn delay={0.2}>
                        <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 text-center hover:border-pink-500/30 transition-colors">
