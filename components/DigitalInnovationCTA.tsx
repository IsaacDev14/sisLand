                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                        <FadeIn direction="right" delay={0.2}>
                            <div className="flex flex-col gap-4">
                                <button className="px-10 py-5 bg-white text-pink-600 font-bold uppercase tracking-widest text-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-3">
                                    Start Building Today
                                    <ArrowRight className="w-5 h-5" />
                                </button>
                                <button className="px-10 py-5 border border-white/30 text-white font-bold uppercase tracking-widest text-sm hover:bg-white/10 transition-all">
                                    Talk to the Team
                                </button>
                            </div>
                        </FadeIn>
